...
description: |
  ...
  loop, no sub-agents. On test or build failure, auto-invokes the spec-backprop
...
2. Read `~/.claude/cavekit/FORMAT.md` once if not loaded.
...
5. **Fail** → invoke spec-backprop skill. Do NOT retry blindly.
