...
description: |
  ...
  the spec or spec-build skills but never invokes them. Triggers when the user
...
- MISSING → invoke spec-build skill on `§T.n` if task exists; else spec skill `amend §T`.
